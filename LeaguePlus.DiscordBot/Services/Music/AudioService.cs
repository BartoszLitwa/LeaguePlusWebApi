...
namespace LeaguePlus.DiscordBot
{
    public sealed class AudioService
    {
        ...
        public AudioService(LavaNode lava, ILogger logger)
        {
            _lavaNode = lava;
            _logger = logger;
            ...
            _lavaNode.OnLog += arg => {
                _logger.LogInformation($"[{arg.Source}] {arg.Message}");
        ...
        {
            _logger.LogError($"Discord WebSocket connection closed with following reason: {arg.Reason}");
            return Task.CompletedTask;
        }
    }
}
