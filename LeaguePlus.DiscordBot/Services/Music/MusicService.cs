...
{
    public sealed class MusicService : ModuleBase<SocketCommandContext>
    {
        ...
        public MusicService(LavaNode node, AudioService audio, ILogger logger)
        {
            _lavaNode = node;
            _audioService = audio;
            _logger = logger;
        ...
        public async Task PlayAsync([Remainder] string searchQuery)
        {
            ...
            foreach (var query in queries)
            {
                ...
                {
                    _logger.LogError($"Could NOT load: {ex.Message}");
                }
            }
        }
